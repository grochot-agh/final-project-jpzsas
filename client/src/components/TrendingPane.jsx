		...
		<div className="flex flex-col justify-center items-center mt-16">
			<div className="relative group">
				<img
					src={image}
					alt={prompt}
					className="w-[410px] h-[260px] rounded-[15px] object-contain bg-white"
				/>
				...
				{share && (
					<div className="flex w-full h-[70px] bg-[#855E5E] dark:bg-[#181616] absolute bottom-0 rounded-bl-[13px] rounded-br-[13px] justify-around items-center">
						<div className="bg-[#a68888] dark:bg-[#252121] w-[330px] h-[50px] rounded-[15px] flex items-center px-3">
							<p className="text-[#ECE0E0] dark:text-[#855e5e] text-[18px]">
								https://...
							</p>
						</div>
						<div className="bg-[#a68888] dark:bg-[#252121] w-[50px] h-[50px] rounded-[15px] flex justify-center items-center cursor-pointer">
