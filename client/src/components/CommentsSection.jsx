...
const CommentsSection = ({ height }) => {
	return (
		<div
			className={`flex flex-col absolute md:top-[80px] top-[60px] left-[30px] comments-gradient dark:comments-dark-gradient w-[450px] h-[${height}] z-10 border-l-4 border-r-4 border-[#af9595] dark:border-[#211717]`}
		>
